...
Media Library Categories/Folders File Manager for WordPress


== Description ==

TEST DRIVE: [https://media-folder.ninjateam.org/create/](https://media-folder.ninjateam.org/create/)
...
<strong>UNLIMITED FOLDERS/ SUBFOLDERS</strong><br>
...
3. Right click to create, rename, edit or delete folder
4. Bulk selectto move / delete files

== Changelog ==
= 1.7 =
Dev 14, 2018 – Version 1.7
