...
class FileBird_Admin {
	...
	public function nt_upload() {
		...
		wp_enqueue_script( 'njt-filebird-sweet-alert-scripts','https://unpkg.com/sweetalert2@7.17.0/dist/sweetalert2.all.js', array( 'jquery' ), $this->version, false );
...
<div id="filebird_sidebar" style="display: none;">
			<div class="filebird_sidebar panel-left">
				...
				<div class="filebird_add_new_container">
					...
					<!-- <button type="button" class="nt_main_add_new js__nt_tipped js__nt_create" data-type="collection" data-title="Click this to create a <strong>new collection</strong>" data-content="A collection can contain no files. But you can create there other collections and <strong>galleries</strong>. The mentioned above gallery is only a <i>gallery data folder</i>, that means they are not automatically in your frontend (your website).<br/><br/>You can create a <strong>visual gallery</strong> from this <i>gallery data folder</i> via the Visual Editor in your page/post."><span class="icon-collection"></span><span class="icon-plus"></span></button> -->
				</div>
				...
				<div id="njt-filebird-defaultTree" class="filebird_tree">
					<ul>
						...
						d="M14.222,-0.000 L1.769,-0.000 C0.787,-0.000 0.009,0.796 0.009,1.778 L-0.000,14.222 C-0.000,15.204 0.787,16.000 1.769,16.000 L14.222,16.000 C15.204,16.000 16.000,15.204 16.000,14.222 L16.000,1.778 C16.000,0.796 15.204,-0.000 14.222,-0.000 ZM14.222,10.667 L10.667,10.667 C10.667,12.138 9.471,13.333 8.000,13.333 C6.529,13.333 5.333,12.138 5.333,10.667 L1.769,10.667 L1.769,1.778 L14.222,1.778 L14.222,10.667 Z"/>
							...
							<span><?php _e('Uncategories', NJT_FILEBIRD_TEXT_DOMAIN);?></span>
						</li>
					</ul>
				</div>
 ...
 */
	...
	public function filebird_pre_upload_ui() {
        ...
        //if ($pagenow === 'media-new.php' || $pagenow === 'post.php' ||  $pagenow === 'post-new.php') {
            ...
            $label = __("Select a folder and upload files. (Option)", NJT_FILEBIRD_TEXT_DOMAIN);
            echo '<p class="attachments-category">' . $label . '<br/></p>
	        <p>
	            <select name="ntWMCFolder" class="njt-filebird-editcategory-filter"><option value="-1">-'.__('Uncategories', NJT_FILEBIRD_TEXT_DOMAIN).'</option>' . $options . '</select>
	        </p>';
      //  }
