...
class FileBird_JS_Translation {
	...
	public static function get_translation(){
		$translation_array = array(
		    ...
		    'this_folder_is_already_exists' => __('This folder is already exists. Please type another name.', NJT_FILEBIRD_TEXT_DOMAIN ),
		    'error_occurred' => __( 'Sorry! An error occurred while processing your request.', NJT_FILEBIRD_TEXT_DOMAIN ),
		    'folder_cannot_be_delete' => __( 'This folder cannot be delete.', NJT_FILEBIRD_TEXT_DOMAIN ),
		    ...
		    'this_page_will_reload' => __( 'This page will reload now.', NJT_FILEBIRD_TEXT_DOMAIN ),
		    'folder_are_sub_directories' => __( 'In this folder are sub directories, please delete them first!', NJT_FILEBIRD_TEXT_DOMAIN ),
		    'are_you_sure' => __( 'Are you sure?' , NJT_FILEBIRD_TEXT_DOMAIN ),
		    'not_able_recover_folder' => __( 'You will not be able to recover this folder! But files in this folder are all safe, they are moved to Uncategories folder.', NJT_FILEBIRD_TEXT_DOMAIN ),
		    ...
		    'limit_folder' => __( 'The FileBird Lite version allows you to manage up to 10 folders.<br>To have unlimited folders, please upgrade to PRO version.</br></br>
		    ...
		    'ok' => __( 'Upgrade to Pro now', NJT_FILEBIRD_TEXT_DOMAIN ),
		    'no_thank' => __( 'No thank', NJT_FILEBIRD_TEXT_DOMAIN ),
