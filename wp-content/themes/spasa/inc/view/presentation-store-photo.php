<?php if(get_field('entry_presentation_store_photo') != ''): ?>
	<div class="view-content">
		<div class="title">
			<h3>Presentation of store / warehouse / showroom <span>(photo)</span></h3>
		</div>
		<div class="value">
			<?php
				$image = get_field('entry_presentation_store_photo');
