<?php if(get_field('entry_presentation_service_fleet_photo') != ''): ?>
	<div class="view-content">
		<div class="title">
			<h3>Presentation of service fleet / van <span>(photo)</span></h3>
		</div>
		<div class="value">
			<?php
				$image = get_field('entry_presentation_service_fleet_photo');
