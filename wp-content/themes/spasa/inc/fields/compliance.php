<?php
	if($wp_query->query_vars['id']):
		$value = str_ireplace(array('<br />','<br>','<br/>'), '', get_field('entry_compliance', $wp_query->query_vars['id']));
	endif;
?>
<p> 
	<label for="compliance">Compliance <span class="info">(Regulations / Safety / Industry / Occupational Health and Safety)</span> <span class="required">*</span></label><br />
	<textarea id="compliance" name="compliance" data-required="required"><?php echo $value; ?></textarea>
