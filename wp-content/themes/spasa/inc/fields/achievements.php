<?php
	if($wp_query->query_vars['id']):
		$value = str_ireplace(array('<br />','<br>','<br/>'), '', get_field('entry_achievements', $wp_query->query_vars['id']));
	endif;
?>
<p> 
	<label for="achievements">Achievements <span class="required">*</span></label><br />
	<textarea id="achievements" name="achievements" data-required="required"><?php echo $value; ?></textarea>
