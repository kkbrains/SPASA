<?php
	if($wp_query->query_vars['id']):
		$value = str_ireplace(array('<br />','<br>','<br/>'), '', get_field('entry_education_training_qualifications', $wp_query->query_vars['id']));
	endif;
?>
<p> 
	<label for="education-training-qualifications">Education / Training / Qualifications <span class="required">*</span></label><br />
	<textarea id="education-training-qualifications" name="education_training_qualifications" data-required="required"><?php echo $value; ?></textarea>
