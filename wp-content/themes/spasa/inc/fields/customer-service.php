<?php
	if($wp_query->query_vars['id']):
		$value = str_ireplace(array('<br />','<br>','<br/>'), '', get_field('entry_customer_service', $wp_query->query_vars['id']));
	endif;
?>
<p> 
	<label for="customer-service">Customer service <span class="required">*</span></label><br />
	<textarea id="customer-service" name="customer_service" data-required="required"><?php echo $value; ?></textarea>
