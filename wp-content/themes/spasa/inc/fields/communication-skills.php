<?php
	if($wp_query->query_vars['id']):
		$value = str_ireplace(array('<br />','<br>','<br/>'), '', get_field('entry_communication_skills', $wp_query->query_vars['id']));
	endif;
?>
<p> 
	<label for="communication-skills">Communication skills <span class="required">*</span></label><br />
	<textarea id="communication-skills" name="communication_skills" data-required="required"><?php echo $value; ?></textarea>
