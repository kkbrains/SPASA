<?php
	if($wp_query->query_vars['id']):
		$value = str_ireplace(array('<br />','<br>','<br/>'), '', get_field('entry_presentation_store', $wp_query->query_vars['id']));
	endif;
?>
<p> 
	<label for="presentation-store">Presentation of store / warehouse / showroom <span class="info">(description)</span> <span class="required">*</span></label><br />
	<textarea id="presentation-store" name="presentation_store" data-required="required"><?php echo $value; ?></textarea>
