<?php
	if($wp_query->query_vars['id']):
		$value = str_ireplace(array('<br />','<br>','<br/>'), '', get_field('entry_description', $wp_query->query_vars['id']));
	endif;
?>
<p> 
	<label for="description">Description <span class="required">*</span></label><br />
	<textarea id="description" name="description" class="big" data-required="required"><?php echo $value; ?></textarea>
