<?php
	if($wp_query->query_vars['id']):
		$value = str_ireplace(array('<br />','<br>','<br/>'), '', get_field('entry_problem_solving', $wp_query->query_vars['id']));
	endif;
?>
<p> 
	<label for="problem-solving">Problem solving <span class="required">*</span></label><br />
	<textarea id="problem-solving" name="problem_solving" data-required="required"><?php echo $value; ?></textarea>
