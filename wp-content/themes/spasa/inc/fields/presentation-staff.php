<?php
	if($wp_query->query_vars['id']):
		$value = str_ireplace(array('<br />','<br>','<br/>'), '', get_field('entry_presentation_staff', $wp_query->query_vars['id']));
	endif;
?>
<p> 
	<label for="presentation-staff">Presentation of staff <span class="info">(description)</span> <span class="required">*</span></label><br />
	<textarea id="presentation-staff" name="presentation_staff" data-required="required"><?php echo $value; ?></textarea>
