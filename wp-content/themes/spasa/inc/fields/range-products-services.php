<?php
	if($wp_query->query_vars['id']):
		$value = str_ireplace(array('<br />','<br>','<br/>'), '', get_field('entry_range_products_services', $wp_query->query_vars['id']));
	endif;
?>
<p> 
	<label for="range-products-services">Range of products / services <span class="required">*</span></label><br />
	<textarea id="range-products-services" name="range_products_services" data-required="required"><?php echo $value; ?></textarea>
